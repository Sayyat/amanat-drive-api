                ...
                <form className="auth-form">
                    ...
                    <div className="auth-form__fields">
                        <div className="auth-form__field field">
                            ...
                            <input type="number" className="field__input" placeholder="Введите ИИН"
                                   onChange={(e) => setIin(e.target.value)}/>
                        </div>
                        <div className="auth-form__field field">
                            <div className="field__title">Номер телефона</div>
                            <input type="tel" className="field__input" placeholder="Введите номер"
                        ...
                        <div className="auth-form__field field">
                            ...
                            <input type="text" className="field__input" placeholder="Введите код из смс"
